  ...
  return (
    <Popover>
      ...
      <Popover.Portal progressAnimationConfigs={progressAnimationConfigs}>
        <Popover.Content className={cn(className.popoverContent, 'w-[240px]')} placement="top">
          <Popover.Arrow stroke={themeColorForeground} fill={themeColorForeground} />
          <AppText className={className.popoverText}>Chat with AI to get recipe suggestions and cooking tips</AppText>
        </Popover.Content>
      </Popover.Portal>
    </Popover>
  );
