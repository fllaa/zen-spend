...
import com.flla.zenspend.core.network.repository.DefaultBudgetRepository
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindBudgetRepository(repository: DefaultBudgetRepository): BudgetRepository
}
