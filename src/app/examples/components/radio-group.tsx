        ...
        <RadioGroup value={withDescSelection} onValueChange={setWithDescSelection}>
          <RadioGroup.Item value="desc1">
            <View>
              ...
              <RadioGroup.Description>Delivered in 5-7 business days</RadioGroup.Description>
            </View>
          ...
          <RadioGroup.Item value="desc2">
            <View>
              ...
              <RadioGroup.Description>Delivered in 2-3 business days</RadioGroup.Description>
            </View>
            <RadioGroup.Indicator />
          </RadioGroup.Item>
          <Divider className="my-1" />
          <RadioGroup.Item value="desc3">
            <View>
              ...
              <RadioGroup.Description>Delivered next business day</RadioGroup.Description>
            </View>
            <RadioGroup.Indicator />
          </RadioGroup.Item>
        </RadioGroup>
...
const StartIndicatorAlignmentContent = () => {
  ...
  return (
    <View className="flex-1 px-5 items-center justify-center">
      <RadioGroup value={shippingSpeed} onValueChange={setShippingSpeed} className="gap-4" isOnSurface>
        <RadioGroup.Item value="standard">
          {({ isSelected }) => (
            ...
            >
              <RadioGroup.Indicator className={cn(!isSelected && 'border border-muted/10')} />
              <View className="flex-1">
                <RadioGroup.Label>Standard Shipping</RadioGroup.Label>
                <RadioGroup.Description>5-7 business days</RadioGroup.Description>
              </View>
              <AppText className={cn('text-foreground font-semibold', isSelected && 'text-accent')}>Free</AppText>
            </View>
          )}
        </RadioGroup.Item>
        ...
        <RadioGroup.Item value="express">
          {({ isSelected }) => (
            ...
            >
              ...
              <AppText className={cn('text-foreground font-semibold', isSelected && 'text-accent')}>$9.99</AppText>
            </View>
          )}
        </RadioGroup.Item>
        ...
        <RadioGroup.Item value="overnight">
          {({ isSelected }) => (
            ...
            >
              ...
              <AppText className={cn('text-foreground font-semibold', isSelected && 'text-accent')}>$24.99</AppText>
            </View>
          )}
        </RadioGroup.Item>
      </RadioGroup>
        ...
        <RadioGroup value={size} onValueChange={setSize} className="flex-row gap-3">
          {sizes.map((sizeOption) => (
            <RadioGroup.Item key={sizeOption} value={sizeOption} className="flex-1 gap-1.5">
              <RadioGroup.Indicator />
              <RadioGroup.Label className="flex-1">{sizeOption}</RadioGroup.Label>
            </RadioGroup.Item>
          ))}
        </RadioGroup>
    ...
    <View className="flex-1 px-5 items-center justify-center">
      <Animated.View className="w-full" layout={LinearTransition}>
        <Surface className="gap-6">
          <View>
            <AppText className="text-foreground font-semibold text-base">Choose Your Plan</AppText>
            <AppText className="text-muted text-sm">Select a subscription plan to continue</AppText>
          </View>
          <RadioGroup value={plan} onValueChange={setPlan} isInvalid={plan === 'enterprise'}>
            <RadioGroup.Item value="basic" isInvalid={false}>
              <View className="flex-1">
                ...
                <RadioGroup.Description>Perfect for individuals - $9/month</RadioGroup.Description>
              </View>
              <RadioGroup.Indicator />
            </RadioGroup.Item>
            ...
            <RadioGroup.Item value="pro" isDisabled isInvalid={false}>
              <View className="flex-1">
                ...
                <RadioGroup.Description>Coming soon - Advanced features</RadioGroup.Description>
              </View>
              <RadioGroup.Indicator />
            </RadioGroup.Item>
            ...
            <RadioGroup.Item value="enterprise" isInvalid>
              <View className="flex-1">
                ...
                <RadioGroup.Description>Not available in your region</RadioGroup.Description>
              </View>
              <RadioGroup.Indicator />
            </RadioGroup.Item>
            <RadioGroup.ErrorMessage>Enterprise plan is not available in your region</RadioGroup.ErrorMessage>
          </RadioGroup>
        </Surface>
      </Animated.View>
    </View>
...
const CustomIndicatorBackgroundContent = () => {
  ...
  return (
    <View className="flex-1 px-5 items-center justify-center">
      <Surface className="w-full gap-6">
        <View>
          <AppText className="text-foreground font-semibold text-base">Priority Level</AppText>
          <AppText className="text-muted text-sm">Set the priority for this task</AppText>
        </View>
            ...
            {({ isSelected }) => (
              <>
                <View className="flex-1">
                  ...
                  <RadioGroup.Description>Urgent - requires immediate attention</RadioGroup.Description>
                </View>
                <RadioGroup.Indicator className={cn('size-8', isSelected && 'bg-red-500 border-red-400')}>
            ...
            {({ isSelected }) => (
              <>
                <View className="flex-1">
                  ...
                  <RadioGroup.Description>Important - complete within this week</RadioGroup.Description>
                </View>
                <RadioGroup.Indicator className={cn('size-8', isSelected && 'bg-amber-500 border-amber-400')}>
            ...
            {({ isSelected }) => (
              <>
                <View className="flex-1">
                  ...
                  <RadioGroup.Description>Standard - complete when possible</RadioGroup.Description>
                </View>
                <RadioGroup.Indicator className={cn('size-8', isSelected && 'bg-emerald-500 border-emerald-400')}>
...
const CustomIndicatorThumbContent = () => {
  ...
  return (
    <View className="flex-1 px-5 items-center justify-center">
      <Surface className="w-full gap-6">
        <View>
          <AppText className="text-foreground font-semibold text-base">Notification Preferences</AppText>
          <AppText className="text-muted text-sm">Choose how you'd like to receive updates</AppText>
        </View>
                ...
                <RadioGroup.Indicator>
                  {isSelected && (
                    <AnimatedView entering={FadeIn.duration(200)}>
                      <StyledFontAwesome name="check" size={12} className="text-accent-foreground" />
                    </AnimatedView>
                  )}
                </RadioGroup.Indicator>
                <View className="flex-1">
                  <RadioGroup.Label>Email Notifications</RadioGroup.Label>
                  <RadioGroup.Description>Get updates via email</RadioGroup.Description>
                </View>
              </>
            )}
          </RadioGroup.Item>
            ...
            {({ isSelected }) => (
              <>
                <RadioGroup.Indicator>
                  {isSelected && (
                    <AnimatedView entering={FadeIn.duration(200)}>
                      <StyledIonicons name="flash" size={12} className="text-background" />
                    </AnimatedView>
                  )}
                </RadioGroup.Indicator>
                <View className="flex-1">
                  <RadioGroup.Label>Push Notifications</RadioGroup.Label>
                  <RadioGroup.Description>Get instant push alerts</RadioGroup.Description>
                </View>
              </>
            )}
          </RadioGroup.Item>
            ...
            {({ isSelected }) => (
              <>
                ...
                <View className="flex-1">
                  ...
                  <RadioGroup.Description>Only check updates manually</RadioGroup.Description>
                </View>
              </>
            )}
          </RadioGroup.Item>
