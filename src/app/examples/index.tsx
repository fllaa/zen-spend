...
import Animated, { Easing, FadeIn, FadeInDown, useAnimatedStyle, withTiming } from 'react-native-reanimated';
...
const HomeCard: FC<HomeCardProps & { index: number }> = ({
  ...
  return (
    ...
    >
      <Card className={cn('p-0 border border-zinc-200', isDark && 'border-zinc-900')}>
        ...
        <View className="gap-4">
          ...
          <Card.Footer className="px-3 pb-3 flex-row items-end gap-4">
            <View className="flex-1">
              <Card.Title className="text-2xl text-foreground/85">{title}</Card.Title>
